...
defmodule KeenAuthDemo.Database.Parsers.AuthEnsureUserFromProviderParser do
  @moduledoc """
  ...
  @spec parse_auth_ensure_user_from_provider_result({:ok, Postgrex.Result.t()} | {:error, any()}) ::
          {:ok,
           [
             KeenAuthDemo.Database.Models.AuthEnsureUserFromProviderItem.t()
           ]}
          | {:error, any()}
  ...
  def parse_auth_ensure_user_from_provider_result_row([
    ...
    {
      :ok,
      %KeenAuthDemo.Database.Models.AuthEnsureUserFromProviderItem{
        user_id: user_id,
        code: code,
        uuid: uuid,
        username: username,
