...
defmodule KeenAuthDemo.Database.Parsers.GetJournalPayloadParser do
  @moduledoc """
  ...
  @spec parse_get_journal_payload_result({:ok, Postgrex.Result.t()} | {:error, any()}) ::
          {:ok,
           [
             KeenAuthDemo.Database.Models.GetJournalPayloadItem.t()
           ]}
          | {:error, any()}
  ...
  def parse_get_journal_payload_result_row([journal_id, payload]) do
    {
      :ok,
      %KeenAuthDemo.Database.Models.GetJournalPayloadItem{
