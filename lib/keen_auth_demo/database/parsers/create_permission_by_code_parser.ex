...
defmodule KeenAuthDemo.Database.Parsers.CreatePermissionByCodeParser do
  @moduledoc """
  ...
  @spec parse_create_permission_by_code_result({:ok, Postgrex.Result.t()} | {:error, any()}) ::
          {:ok,
           [
             KeenAuthDemo.Database.Models.CreatePermissionByCodeItem.t()
           ]}
          | {:error, any()}
  ...
  def parse_create_permission_by_code_result_row([
    ...
    {
      :ok,
      %KeenAuthDemo.Database.Models.CreatePermissionByCodeItem{
        created: created,
