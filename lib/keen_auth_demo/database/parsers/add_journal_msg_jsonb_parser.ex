...
defmodule KeenAuthDemo.Database.Parsers.AddJournalMsgJsonbParser do
  @moduledoc """
  ...
  @spec parse_add_journal_msg_jsonb_result({:ok, Postgrex.Result.t()} | {:error, any()}) ::
          {:ok,
           [
             KeenAuthDemo.Database.Models.AddJournalMsgJsonbItem.t()
           ]}
          | {:error, any()}
  ...
  def parse_add_journal_msg_jsonb_result_row([
    ...
    {
      :ok,
      %KeenAuthDemo.Database.Models.AddJournalMsgJsonbItem{
        created: created,
